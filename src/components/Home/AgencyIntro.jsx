    ...
    <section className="w-full relative">
        ...
        <div className="w-full md:w-1/2  bg-[#18191b] h-[400px] flex flex-col items-center justify-center">
          ...
          <div className="space-y-6">
            ...
            <h2 className="text-[30px] font-bold text-white leading-tight w-[400px]">
              We are the USA-based company offering a wide Range of services at
              a competitively low cost.
            </h2>
          </div>
        </div>
        ...
        <div className="w-full md:w-1/2 bg-[#18191b] md:bg-[#0e0f11] h-[400px] flex flex-col items-center justify-center pt-80 md:pt-0 pb-36 md:pb-0">
          ...
          <div className="space-y-8">
            <p className="text-[#ccc] font-semibold w-[400px]">
              Step into the future of digital excellence with Softvence Agency,
              where we provide a spectrum of services at a competitive cost! Our
              passionate team blends creativity with functionality, ensuring
              success that connects with vision. Softvence Agency – where
              quality meets affordability, creating a digital impact.
            </p>
      ...
      <div className="flex justify-center items-center absolute top-[42%] md:top-[25%] left-[15%] md:left-[46%] ">
        <div className="border-[1px] border-[#ccc] px-10 py-8 text-center">
          ...
          <p className=" text-white font-semibold text-[20px]">Completed Projects</p>
        </div>
      </div>
    </section>
  );
